...
const DEFAULT_PAGEHEADER = {
  ...
  description:
    'Discover how our advanced manufacturing execution system transforms production lines with real-time monitoring, quality control, and operational intelligence.',
  ctaText: 'Explore Our Solutions',
  ctaHref: '/contact',
  hasBackground: false, // Toggle for background color
  stat1Label: 'Production Lines',
  stat1Value: '500+',
  stat2Label: 'Quality Improvement',
  stat2Value: '99.2%',
  stat3Label: 'System Uptime',
  stat3Value: '99.9%',
  stat4Label: 'Cost Reduction',
  stat4Value: '35%',
