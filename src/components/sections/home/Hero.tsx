...
const DEFAULT_HERO = {
  badge: 'New: AI-Powered MES Platform',
  title: 'Transform your factory floor with',
  titleHighlight: 'Smart Manufacturing Execution',
  description:
    'Streamline production workflows, optimize resource allocation, and achieve real-time visibility across your entire manufacturing operation with our next-generation MES platform.',
  features: [
    'Real-time production tracking',
    'Predictive quality control',
    'Automated workflow optimization',
    'Industry 4.0 ready integration',
  ],
  ...
  imageAlt: 'Smart manufacturing dashboard interface',
  statsLabel1: 'Efficiency Boost',
  statsValue1: '35% Average',
  statsLabel2: 'Downtime Reduction',
  statsValue2: '60% Less',
} as const;
